...
def ctl_treat_class(df_2):
    ...
    '''This function receives a df and return a copy with NA cells filled with None'''
...
def add_srr_count_col(df_col_reorder, df_gsm_adr_srx_srr_final):
    '''This function receives two dfs and returns a df_final with the re-ordered columns'''
